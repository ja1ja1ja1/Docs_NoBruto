...
<html>
  ...
  <body name="body">
  <div class="box-edit">
    <button id="font-family"><i class="fa-solid fa-font"></i></button>
    <button id="txt-height"><i class="fa-solid fa-text-height"></i></button>
    ...
    <button id="hiliteColor"><i class="fa-solid fa-highlighter"></i></button>
    <button id="txt-color"><i class="fa-solid fa-palette"></i></button>
    <button id="justifyLeft" ><i class="fa-solid fa-align-left"></i></button>
    <button id="justifyRight" ><i class="fa-solid fa-align-right"></i></button>
    <button id="justifyFull" ><i class="fa-solid fa-align-justify"></i></button>
    <button id="justifyCenter" ><i class="fa-solid fa-align-center"></i></button>
  ...
  <script>
    let fontSize = 11
    const btnsEdit = [...document.querySelectorAll(".box-edit button")]
